...
import io.github.gabrmsouza.subscription.infrastructure.authentication.clientcredentials.GetClientCredentials;
...
class KeycloakIdentityProviderClientTest extends AbstractRestClientTest {
    ...
    public void givenValidParams_whenCallsCreateUser_shouldReturnUserId() {
        ...
        // then
        assertEquals(expectedUserId, actualResponse);
    ...
    public void givenUserAlreadyRegistered_whenCallsCreateUser_shouldReturnConflict() {
        ...
        // when
        var actualError = assertThrows(DomainException.class, () -> this.client.create(user));

        // then
        assertEquals(expectedError, actualError.getErrors().getFirst().message());
    }
    ...
    public void givenEmptyAuthorization_whenCallsAddUserToGroup_shouldReturnError() {
        ...
        // when
        var actualError = assertThrows(InternalErrorException.class, () -> this.client.addUserToGroup(expectedUserId, expectedGroupId));
    ...
    public void givenEmptyAuthorization_whenCallsRemoveUserFromGroup_shouldReturnError() {
        ...
        // when
        var actualError = assertThrows(InternalErrorException.class, () -> this.client.removeUserFromGroup(expectedUserId, expectedGroupId));
