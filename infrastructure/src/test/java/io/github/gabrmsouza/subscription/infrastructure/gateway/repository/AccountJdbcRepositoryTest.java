...
import io.github.gabrmsouza.subscription.AbstractRepositoryTest;
...
import io.github.gabrmsouza.subscription.domain.account.AccountEvent;
...
class AccountJdbcRepositoryTest extends AbstractRepositoryTest {
    ...
    public void givenEmptyTable_whenPersistSuccessfully_shouldHaveUserAtTheEndOfOperation() {
        ...
        final var actualEvents = this.eventRepository().allEventsOfAggregate(expectedId.value(), AccountEvent.TYPE);
