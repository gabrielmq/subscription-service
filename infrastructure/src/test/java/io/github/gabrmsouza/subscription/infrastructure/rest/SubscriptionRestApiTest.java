...
import io.github.gabrmsouza.subscription.infrastructure.rest.controllers.SubscriptionRestController;
...
public class SubscriptionRestApiTest {
    ...
    public void givenValidInput_whenCreateSuccessfully_shouldReturnSubscriptionId() throws Exception {
        ...
        assertEquals(expectedPlanId, actualRequest.planId());
        assertEquals(expectedAccountId, actualRequest.accountId());
    }
    ...
    public void givenValidAccountId_whenChargedSuccessfully_shouldReturnNewSubscriptionStatus() throws Exception {
        ...
        assertEquals(expectedAccountId, actualRequest.accountId());
        assertEquals(expectedCreditCardToken, actualRequest.creditCardToken());
        assertEquals(expectedPaymentType, actualRequest.paymentType());
    }
